          ...
          <div className="w-full h-full">
            <div className="flex justify-start gap-3 items-center text-slate-600 text-xl h-[50px]">
              <div className="w-[30px] h-[30px] rounded-full relative">
                ...
                <img src="http://localhost:3000/images/sellers/1.png" alt="" />
              </div>
              <span>Đinh Minh Hiếu</span>
            </div>
            <div className="h-[400px] w-full bg-slate-100 p-3 rounded-md bg-slate-400">
              <div className="w-full h-full overflow-y-auto flex flex-col gap-3">
                <div className="w-full flex gap-2 justify-start items-center text-[14px]">
                  <img
                    ...
                    alt=""
                  />
                  <div className="p-2 bg-white font-semibold rounded-md">
                    <span>Xin chào</span>
                  </div>
                </div>
                <div
